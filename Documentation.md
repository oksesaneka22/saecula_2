...
│   ├── buildings/           # Схеми та параметри будівель (campfire 2x2, stockpile 4x4, wooden_hut 6x6)
...
- **Процедурні 3D моделі:**
  ...
  - **Хатина (`wooden_hut`):** просторі стіни зрубу 12x12м, двосхилий дах-призма, дубові двері, настінний ліхтар біля входу.
...
- **Параметри:** розмір 6x6 клітинок (8x8м у 3D), місткість 32 слоти.
